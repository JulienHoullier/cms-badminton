...
Registered.add({
    ...
    state : {type : Types.Select, options: 'En attente, Envoyée, Confirmée, Tournois terminé', default: 'En attente', required : true, initial : true}        //cycle de vie En attente -> Envoyé ->  Confirmé -> Tournois terminé
});
