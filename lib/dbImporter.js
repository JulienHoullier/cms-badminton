			...
			if(err){
				...
				for(var i=1; i<table.length; i++){
					...
					if(tr) {
						...
						users.push({"name.first": firstname, "name.last": lastname, "email": "fake@yopmail.com", "licence": licence, "type": isYoung?"young":(isCompetitor ? "competitor": "leisure"), "timeSlot": 'wednesday_strong' });
					}
				}
